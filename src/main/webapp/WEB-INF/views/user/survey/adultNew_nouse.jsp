        ...
        $(document).ready(function() {
           ...
           switch(viewMode){
            ...
            $("#info_toggle").click(function(){
            	if($(".surveyTop").css("display") == "block"){
            		$(".surveyTop").slideUp("100");	
            	}else{
            		$(".surveyTop").slideUp("100");
            	}            	
            });
...
<div class="surveyTop">
	...
	<div class="surveyInfo">
		<ul>
			...
			<li>식별번호 : 13-1-210(길병원 20192398)</li>
		</ul>
	</div>
</div>
<div style="text-align:center;" id="info_toggle">닫기</div>
...
<div id="fullpage">
	...
	<div class="section" id="section1">
		...
		<div class="slide" id="slide1">
			...
			<div class="fp-auto-height" id="q01">
			<div class="qest_wrap">
				...
				<div class="qest_anwer_wrap">
				    ...
				    <label class="label_txt"><input type="checkbox" class="input_check">호흡기 증상이 있어서 사용(진단명 : <input type="text" class="input_txt_m">)<br/></label>
				    <label class="label_txt"><input type="checkbox" class="input_check">피부 증상이 있어서 사용(진단명 : <input type="text" class="input_txt_m">)<br/></label>
				    <label class="label_txt"><input type="checkbox" class="input_check">기타(<input type="text" class="input_txt_m">)</label>
				</div>
		...
		<div class="slide" id="slide2">
			<div class="fp-auto-height" id="q02">
			    <div class="qest_wrap">
...
<!-- 
		<div class="slide" id="slide3">
			<div class="fp-auto-height" id="q02-1">
			    <div class="qest_wrap">
		...
		<div class="slide" id="slide4">
			<div class="fp-auto-height" id="q03">
			    <div class="qest_wrap">
		...
		<div class="slide" id="slide5">
			<div class="fp-auto-height" id="q04">
			    <div class="qest_wrap">
		...
		<div class="slide" id="slide6">
			<div class="fp-auto-height" id="q05">
			    <div class="qest_wrap">
				...
				<div class="qest_anwer_wrap">
				    ...
				    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label class="label_txt"><input type="checkbox" class="input_check">금연 전 하루 평균 흡연량은?<input type="text" class="input_txt_s"/>(개비)<br/></label>
		...
		<div class="slide" id="slide7">
			<div class="fp-auto-height" id="q06">
			    <div class="qest_wrap">
		...
		<div class="slide" id="slide8">
			<div class="fp-auto-height" id="q07">
			    <div class="qest_wrap">
				<span class="qest_no">07 Question</span>
				<div class="qest_title">
				    아래의 질문에 <b><u>정확하게 아는대로 기술</u></b>해 주시기를 부탁드립니다.
				</div>
				<div class="qest_anwer_wrap">
				    <table class="ques_table">
					<colgroup>
		...
		<div class="slide" id="slide9">
			<div class="fp-auto-height" id="q08">
			    <div class="qest_wrap">
		...
		<div class="slide" id="slide10">
			<div class="fp-auto-height" id="q09">
			    <div class="qest_wrap">
				...
				<div class="qest_anwer_wrap">
					...
					<table class="ques_table">
						...
						<td>약물명</td>
						<td>
						    <textarea class="txt_area" style="height:60px"></textarea>
						</td>
						<td>
						    <textarea class="txt_area" style="height:60px"></textarea>
						</td>
		...
		<div class="slide" id="slide11">
			<div class="fp-auto-height" id="q10">
			    <div class="qest_wrap">
		...
		<div class="slide" id="slide12">
			<div class="fp-auto-height" id="q11">
			    <div class="qest_wrap">
